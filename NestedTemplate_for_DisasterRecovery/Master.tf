...
parameters = {
	"Location_of_Virtual_Network1"  			= "West US",
	"NSG1_name" 				    			= "NSG-1-web",
	"NSG2_name" 								= "NSG-1-api",
	"NSG3_name" 								= "NSG-1-db",
	...
	"subnet1_AddressPrefix_Vnet2"				= "20.0.1.0/24",
	"subnet2_Name_Vnet2"						= "subnet-2-replica",
	"subnet2_AddressPrefix_Vnet2"				= "20.0.2.0/24",	
	"subnet3_Name_Vnet2"						= "subnet-3-replica",	
	"subnet3_AddressPrefix_Vnet2"				= "20.0.3.0/24",
