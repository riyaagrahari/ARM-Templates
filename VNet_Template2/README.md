...
For default values , you may refer to [`parameters.json`](https://github.com/riyaagrahari/ARM-Templates/blob/master/VNet_Template/parameters.json) file.

### It can be executed by three ways:

### 1. Azure Portal 

<a href="https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Friyaagrahari%2FARM-Templates%2Fmaster%2FVNet_Template%2Ftemplate.json" target="_blank">
