...
To create Virtual Network you can refer to [`Vnet Template`](https://raw.githubusercontent.com/riyaagrahari/ARM-Templates/master/VNet_Template/template.json) file.
For default values, you may refer to [`parameter_Peering.json`](https://raw.githubusercontent.com/riyaagrahari/ARM-Templates/master/Vnet_Peering_Template/parameter_Peering.json) file.
